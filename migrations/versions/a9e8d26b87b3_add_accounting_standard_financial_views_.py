...
def upgrade():
    ...
    # Note: Commented out drop_column operations for columns that don't exist in fresh databases
    #       These columns (price_per_user, goal_users, etc.) only existed in legacy migrated databases
